...
add wave -noupdate -radix binary /testbench/flags
add wave -noupdate -radix binary /testbench/expected_flags
add wave -noupdate -radix decimal /testbench/CHECKER/errors
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {ADD {12 ns} 0} {SUBTRACT {131 ns} 0} {MULTIPLY {210 ns} 0}
